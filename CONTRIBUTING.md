...
Olá! Obrigado pelo interesse em contribuir com as Pesquisas e Narrativas do Pegabot!
...
* Proponham novas formas de uso do Pegabot
* Proponha melhorias nos atuais usos da ferramenta
* Estabeleça novas formas de comunicação
* Proponha de maneira descritiva melhores técnicas para a ferramenta
* Faça diferentes tipos de classificação de perfis
...
O repositório se encontra vazio. Deverá ser feita uma implementação a partir do zero.
